...
def search(request):
    ...
    if request.method == 'POST':
        ...
        # Test for null
        if not searched:
            messages.success(request,"That Product is None")
...
def login_user(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            # Convert database string to python dictionry
            if saved_cart:
...
def logout_user(request):
    logout(request)
    messages.success(request,("You have been logged out ..Thanks you"))
    return redirect('home')
...
def register_user(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(request,("Register was a problem Please try again"))
    else:
